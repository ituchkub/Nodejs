const truckCon = require('../../utils/mssql/truckcondition.mssql')

class truckConditionService {
  async getList(req) {
    try {
      const output = await truckCon.getList(req.body);
...
module.exports = new truckConditionService();